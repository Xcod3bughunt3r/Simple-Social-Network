...
<html lang="en">
	<head>
		...
		<meta name="author" content="ALIF FUSOBAR">
	...
	<body>
		...
		<div class="footer-copyright">
			<div class="container">
				<p class="text-muted credit text-center">&copy; <?= date('Y') ?> <a href="https://Xcod3bughunt3r.github.io/Simple-Social-Network" title="">Fav Quote</a> / <a href="<?= $baseUrl; ?>/terms">Terms of Service</a></p>
			</div>
		</div>
